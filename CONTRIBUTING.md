# Contributing to Llama Notifications

Thank you for your interest in contributing to Llama Notifications! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama Notifications:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-notifications.git
   cd llama-notifications
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-notifications.git
   ```
...
By contributing to Llama Notifications, you agree that your contributions will be licensed under the project's MIT License.
